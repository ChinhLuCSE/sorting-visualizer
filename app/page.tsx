...
export default function Home() {
  ...
  const handleSelectAlgorithm = (e: React.ChangeEvent<HTMLSelectElement>) => {
      ...
      <div className="flex h-full justify-center">
        ...
        >
          <div className="h-[66px] relative flex items-center justify-between w-full">
            <p className="text-sm text-gray-300 hidden sm:flex">@chinhlucse</p>
            ...
            <div className="hidden sm:flex absolute top-[120%] left-0 w-full">
              <div className="flex w-full text-gray-400 p-4 rounded border border-system-purple20 bg-system-purple80/10 gap-6">
